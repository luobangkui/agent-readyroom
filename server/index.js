...
import {Edge0Bridge} from './edge0.js';
...
const bridge=new OfficeRuntimes({codex:new CodexBridge({cwd:root}),zcode:new ZcodeBridge({cwd:root}),edge0:new Edge0Bridge({cwd:root,dataDir}),dsh:new DshBridge({cwd:root})});
